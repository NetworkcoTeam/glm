    ...
    <footer className="bg-gradient-to-br  from-black via-gray-800 to-gray-700 border-amber-900">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Quick Links */}
          <div className="bg-[hsl(270,50%,15%)]/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg shadow-[hsl(270,70%,30%)]/50 transition-transform duration-300 hover:scale-105 border-2 border-amber-600 ">
            ...
            <ul className="space-y-2">
              {['HomePage', 'About', 'ContactUs', 'Portfolio', 'Service'].map((item, index) => (
                <li key={index}>
                  <Link to={`/${item.replace(/\s+/g, '-').toLowerCase()}`} className="text-[hsl(190,60%,90%)] hover:text-amber-400 transition duration-300">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div className="bg-[hsl(270,50%,15%)]/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg shadow-[hsl(270,70%,30%)]/50 transition-transform duration-300 hover:scale-105 border-2 border-amber-600">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/gold-label-media/ " className="text-[hsl(190,60%,90%)] hover:text-amber-400 transition duration-300 transform hover:scale-125">
                <Linkedin className="h-6 w-6" />
              </a>
              <a href=" https://www.instagram.com/goldlabelmedia_sa?igsh=M2YzZzViZmk4dHlo" className="text-[hsl(190,60%,90%)] hover:text-amber-400 transition duration-300 transform hover:scale-125">
                <Instagram className="h-6 w-6" />
              </a>
              <a href="https://www.tiktok.com/@gold.label.media?_t=ZS-8xWbBCiIRdw&_r=1" className="text-[hsl(190,60%,90%)] hover:text-amber-400 transition duration-300 transform hover:scale-125">
          ...
          <div className="bg-[hsl(270,50%,15%)]/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg shadow-[hsl(270,70%,30%)]/50 transition-transform duration-300 hover:scale-105 border-2 border-amber-600">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="text-[hsl(190,60%,90%)] bg-[hsl(270,50%,20%)]/50 border-amber-600 border-2 placeholder:text-[hsl(190,60%,70%)] focus:ring-pink-500 focus:border-pink-500 p-2 rounded"
              />
              <button
